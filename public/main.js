...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(aService, router, msg) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.aService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                _this.aService.storeUserData(data.token, data.user);
                _this.msg.show('You are now logged in', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.msg.show(data.msg, { cssClass: 'alert-danger', timeout: 3000 });
            }
        });
    };
...
module.exports = "<div class=\"navbar\">\r\n  <h1 class=\"mr-md-auto logo\">EB project</h1>\r\n  <nav class=\"mynav\">\r\n    <a class=\"p-2 text-dark\" routerLink=\"/\">Home</a>\r\n    <div *ngIf=\"aService.loggedIn()\" class=\"dropdown myDrop\">\r\n      <button class=\"btn btn-secondary dropdown-toggle myAccountBtn\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\r\n        aria-haspopup=\"true\" aria-expanded=\"false\">\r\n        my Account\r\n      </button>\r\n      <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">\r\n        <a *ngIf=\"aService.loggedIn()\" class=\"dropdown-item\" routerLink=\"/dashboard\">Dashboard</a>\r\n        <a *ngIf=\"aService.loggedIn()\" class=\"dropdown-item\" routerLink=\"/profile\">Profile</a>\r\n        <a *ngIf=\"aService.loggedIn()\" class=\"dropdown-item\" (click)=\"onLogoutClick()\" href=\"/login\">Sign out</a>\r\n      </div>\r\n    </div>\r\n    <div >\r\n      <a *ngIf=\"!aService.loggedIn()\" class=\"p-2 text-dark\" routerLink=\"/login\">Sign in</a> \r\n      <a *ngIf=\"!aService.loggedIn()\" class=\"p-2 text-blue\" routerLink=\"/register\">Sign up</a>\r\n    </div>\r\n  </nav>\r\n</div>"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(aService, router) {
        this.aService = aService;
        this.router = router;
    }
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(aService, router) {
        this.aService = aService;
        this.router = router;
    }
    ProfileComponent.prototype.ngOnInit = function () {
        // this.aService.getProfile().subscribe(
        //   profile => {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(vService, msg, aService, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        var vRegister = this.vService.validateRegister(user);
        var vEmail = this.vService.validateEmail(user.email);
        var register = function (myuser) {
            return _this.aService.registerUser(myuser).subscribe(function (data) {
                console.log(data);
                if (data.success) {
                    _this.msg.show("you are successfully registered", {
                    ...
                    _this.msg.show("something went wrong", {
                        cssClass: "alert-success",
                        timeout: 3000
                    });
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(aService, router) {
        this.aService = aService;
        this.router = router;
    }
...
module.exports = __webpack_require__(/*! C:\Users\ajmik\Hayden\eb_project\angular-src\src\main.ts */"./src/main.ts");
